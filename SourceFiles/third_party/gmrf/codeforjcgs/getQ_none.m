function [ Q,neighborcount ] = getQ_none(observedmap,i1,i2array,parms,nu)

% returns the approximate precision matrix with no adjustments
% for boundary observations or missing observations
