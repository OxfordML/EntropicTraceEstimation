...
observedmap = zeros(288,181);
for i = 1:26633
observedmap(lon2(i),lat2(i)) = 1;
end;

subdata = zeros(288,181);
for i = 1:26633
subdata(lon2(i),lat2(i)) = z(i);
end;
...
tic
-loglikfast(zarray,observedmap,i1,i2array,D,.1,[1000 exp(log([0.01 0.3]))],nu,J,1,1);
